def gaji_karyawan():
    ...
    print("{:<15}: {:>2} Tahun".format("Masa Kerja", masa_kerja))
    print("{:<15}: {:>2}".format("Golongan", golongan))
    print("{:<13}: {:>3} Jam".format("Total Jam Kerja", total_jam_kerja))
    print('=' *50)
    print("{:^50}".format("PERHITUNGAN GAJI"))
    print('=' *50)
    print("{:<15}: Rp.{:>8,}".format("Gaji Pokok", gaji))
    print("{:<15}: Rp.{:>8,}".format("Tunjangan", tunjangan))
    print("{:<15}: Rp.{:>8,}".format("Gaji Lembur", gaji_lembur))
    print('-' *50)
    print("{:<15}: Rp.{:>8,}".format("Total Gaji", total_gaji))
    print('-' *50)
gaji_karyawan()
