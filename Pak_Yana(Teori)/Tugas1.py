def gaji_karyawan():
    ...
    print("{:<15}: {:>2}".format("Masa Kerja", masa_kerja, "tahun"))
    print("{:<15}: {:>2}".format("Golongan", golongan))
    print("{:<13}: {:>3}".format("Total Jam Kerja", total_jam_kerja, "jam"))
    print('-' *25)
    print("{:^20}".format("PERHITUNGAN GAJI"))
    print('-' *25)
    print("{:<12}: {:>8,}".format("Gaji Pokok", gaji))
    print("{:<12}: {:>8,}".format("Tunjangan", tunjangan))
    print("{:<12}: {:>8,}".format("Gaji Lembur", gaji_lembur))
    print('-' *25)
    print("{:<12}: {:>8,}".format("Total Gaji", total_gaji))
    print('-' *25)
gaji_karyawan()